...
STR_CONFIG_ITEMS = [
    "account", "authenticator", "config_dir", "installer", "logs_dir",
    "post_hook", "pre_hook", "pref_challs", "renew_hook", "server",
    "standalone_supported_challenges", "user_agent", "work_dir"]
